      ...
      <main className="mx-auto max-w-7xl px-6 py-10">
        <div className="rounded-3xl bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-slate-600">
            Start scanning notes, generating quizzes and studying with
            Learnify to view performance analytics.
          </p>
        </div>
      </main>
    );
    ...
    <main className="mx-auto max-w-7xl px-6 py-10">
      ...
      <section className="rounded-3xl bg-gradient-to-r from-blue-700 to-indigo-700 p-8 text-white shadow-lg">
        ...
        <p className="mt-3 max-w-2xl text-blue-100">
          Track your study habits, quiz performance, weak areas,
          and learning progress across all subjects.
        </p>
      </section>
      ...
      <section className="mt-8 rounded-3xl border border-blue-100 bg-blue-50 p-6">
        ...
        <p className="mt-3 text-slate-700">
          Focus on topics listed under weak areas. Generate more quizzes,
          schedule revision sessions in Study Planner, and use AI Tutor
...
function AnalyticsCard({ title, value, color }) {
  ...
  return (
    <div
      className={`rounded-3xl p-6 shadow-sm ${colors[color]}`}
    >
